...
export default function App(){
  ...
  const refresh=useCallback(async()=>{
    if(refreshToken.current||authEntry.startsWith('#auth')||!sessionRef.current?.user)return;
